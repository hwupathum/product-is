...
public class TenantFailureTest extends TenantManagementBaseTest {
    ...
    public void testGetTenantsInvalidFilterOperation() {
        ...
        Response response = getResponseOfGet(TENANT_API_BASE_PATH + "?filter=domainName ne abc.com");
        validateErrorResponse(response, HttpStatus.SC_BAD_REQUEST, "TM-60024", "ne");
    }
